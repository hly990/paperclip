...
const SURFACE_KEYS = [
  {
    titleKey: "component.accounting.inferenceLedger",
    descriptionKey: "component.accounting.inferenceLedgerDesc",
    icon: Database,
    pointKeys: [
      "component.accounting.tokensAndBilled",
      "component.accounting.providerBillerModel",
      "component.accounting.subscriptionOverage",
    ],
    tone: "from-sky-500/12 via-sky-500/6 to-transparent",
  },
  {
    titleKey: "component.accounting.financeLedger",
    descriptionKey: "component.accounting.financeLedgerDesc",
    icon: ReceiptText,
    pointKeys: [
      "component.accounting.topUpsRefundsFees",
      "component.accounting.bedrockProvisionedTraining",
      "component.accounting.creditExpiriesAdjustments",
    ],
    tone: "from-amber-500/14 via-amber-500/6 to-transparent",
  },
  {
    titleKey: "component.accounting.liveQuotas",
    descriptionKey: "component.accounting.liveQuotasDesc",
    icon: Gauge,
    pointKeys: [
      "component.accounting.providerQuotaWindows",
      "component.accounting.billerCreditSystems",
      "component.accounting.errorsSurfacedDirectly",
    ],
    ...
    <Card className="relative overflow-hidden border-border/70">
      ...
      <CardHeader className="relative px-5 pt-5 pb-2">
        <CardTitle className="text-sm font-semibold uppercase tracking-[0.22em] text-muted-foreground">
          {t("component.accounting.title")}
        </CardTitle>
        <CardDescription className="max-w-2xl text-sm leading-6">
          {t("component.accounting.description")}
        </CardDescription>
      </CardHeader>
