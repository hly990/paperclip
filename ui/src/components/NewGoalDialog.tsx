...
const levelLabelKeys: Record<string, string> = {
  company: "dialog.goal.levelCompany",
  team: "dialog.goal.levelTeam",
  agent: "dialog.goal.levelAgent",
  task: "dialog.goal.levelTask",
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("dialog.goal.titleSubGoal") : t("dialog.goal.title")}</span>
          </div>
        ...
        <div className="px-4 pt-4 pb-2 shrink-0">
          <input
            ...
            placeholder={t("dialog.goal.titlePlaceholder")}
            value={title}
        ...
        <div className="px-4 pb-2">
          <MarkdownEditor
            ...
            placeholder={t("dialog.goal.descriptionPlaceholder")}
            bordered={false}
          ...
          <Popover open={levelOpen} onOpenChange={setLevelOpen}>
            ...
            <PopoverContent className="w-40 p-1" align="start">
              {GOAL_LEVELS.map((l) => (
                ...
                >
                  {levelLabelKeys[l] ? t(levelLabelKeys[l]) : l}
                </button>
              ))}
            </PopoverContent>
          </Popover>
          ...
          <Popover open={parentOpen} onOpenChange={setParentOpen}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1.5 rounded-md border border-border px-2 py-1 text-xs hover:bg-accent/50 transition-colors">
                ...
                {currentParent ? currentParent.title : t("dialog.goal.parentGoal")}
              </button>
            </PopoverTrigger>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("dialog.goal.creating") : newGoalDefaults.parentId ? t("dialog.goal.createSubGoal") : t("dialog.goal.create")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
