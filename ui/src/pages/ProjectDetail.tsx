  ...
  return (
    <div className="space-y-6">
      <InlineEditor
        ...
        placeholder={t("page.projects.addDescription")}
        multiline
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        ...
        {project.targetDate && (
          <div>
            <span className="text-muted-foreground">{t("page.projects.targetDate")}</span>
  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        aria-label={t("page.projects.changeColor")}
      />
      {open && (
...
export function ProjectDetail() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: project?.name ?? routeProjectRef ?? t("page.projects.project") },
    ]);
    ...
    <div className="space-y-6">
        ...
        <div className="min-w-0 space-y-2">
          ...
          {project.pauseReason === "budget" ? (
            <div className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-[11px] font-medium uppercase tracking-[0.18em] text-red-200">
              ...
              {t("page.projects.pausedByBudget")}
            </div>
          ) : null}
        </div>
      </div>
      ...
      <Tabs value={activeTab ?? "list"} onValueChange={(value) => handleTabChange(value as ProjectTab)}>
        <PageTabBar
          items={[
            ...
            { value: "overview", label: t("page.projects.overview") },
            ...(showWorkspacesTab ? [{ value: "workspaces", label: t("page.projects.workspaces") }] : []),
            { value: "configuration", label: t("page.projects.configuration") },
            { value: "budget", label: t("page.projects.budget") },
      ...
      {activeTab === "workspaces" ? (
        workspaceTabDecisionLoaded ? (
          ...
          <p className="text-sm text-muted-foreground">{t("page.projects.loadingWorkspaces")}</p>
        )
      ) : null}
